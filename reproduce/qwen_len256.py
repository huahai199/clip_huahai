...
LEARNING_RATE     = 1e-4
TEMPERATURE       = 0.07
MAX_TEXT_LENGTH   = 256      # ← 对齐 CLIP 原生 77 token
...
class MHAWithLength(nn.Module):
    def __init__(self, qwen_name, clip_name, embed_dim=768, mha_heads=8, trunc_len=256):
        super().__init__()
