...
EVAL_START_LOSS   = 1.0
SAVE_DIR          = "./checkpoints_joint/exp1_mha_q8"
USE_AMP           = True
...
class MultiHeadAttentionPooling(nn.Module):
    def __init__(self, hidden_size, num_heads=8):
        ...
        self.agg_queries = nn.Parameter(torch.randn(8, hidden_size) * 0.02)  # N个查询向量
        self.num_queries = 8
...
def train():
    ...
    print("=" * 55)
    print("  MHA Pooling (8 queries) + Patch 融合残差")
    print("=" * 55)
